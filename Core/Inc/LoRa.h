...
public:
	...
	int Transmit_Package_A(double batteryVoltage, double latitude, double longitude, int nSatellites);
	int Transmit_Package_B(double speed, double altitude, char* timeStr);
